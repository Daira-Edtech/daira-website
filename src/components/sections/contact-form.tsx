...
export default function ContactForm() {
  ...
  return (
    <>
      ...
      <section 
        className="section-padding bg-[#F8F3ED] overflow-hidden" 
        id="partner"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p 
                  className="text-[12px] font-semibold uppercase tracking-wider text-white/80 mb-8"
                ...
                <h2 
                  className="font-display text-[48px] lg:text-[56px] leading-[1.1] text-white mb-6"
                ...
                <p 
                  className="text-[16px] lg:text-[18px] text-white/90 max-w-md leading-relaxed"
                  style={{ fontFamily: '"Noto Sans", sans-serif' }}
                >
            ...
            <div 
              className="p-10 lg:p-12 rounded-[24px] bg-white/40 backdrop-blur-md border border-white/20"
              style={{ fontFamily: '"Noto Sans", sans-serif' }}
            >
              <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
                ...
                <div>
                  <p 
                    className="text-[14px] font-medium text-[#7A6F68] mb-4"
                    style={{ fontFamily: '"Noto Sans", sans-serif', fontWeight: 500 }}
                  >
                ...
                <p 
                  className="text-center text-[12px] text-[#7A6F68]"
                  style={{ fontFamily: '"Noto Sans", sans-serif' }}
                >
