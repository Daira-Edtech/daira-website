    ...
    <footer className="w-full bg-[#F8F3ED] text-[#2D241E] pt-24 pb-12 overflow-hidden">
      <div className="container mx-auto max-w-[1200px] px-8">
        ...
        <div className="flex flex-col items-center text-center space-y-6 mb-16">
          <h2 className="font-display text-[48px] leading-tight tracking-tight">Daira EdTech</h2>
        ...
        <div className="relative w-full flex justify-center mb-16 pointer-events-none">
        ...
        <div className="pt-8 border-t border-[#2D241E]/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[#2D241E]/50 text-[13px] font-sans">
          <div className="flex flex-col md:flex-row gap-2 md:gap-4 items-center">
            <p>© 2025 Daira EdTech Private Limited. All rights reserved.</p>
          </div>
